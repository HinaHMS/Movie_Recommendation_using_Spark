...
def df_top10_rec(df,dfName):
    try:
        logger.info(f"The Data Frame Validation by top 10 record df_top10_rec() is started for Dataframe {dfName}...")
        ...
        logger.info(f"The DataFrame Validation by top 10 record df_top10_rec() is completed.")
